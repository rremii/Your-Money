...
import { EditCreateMenuType, Menus } from "@entities/UI/types.ts"
...
export const { closeMenu, setEditCreateMenuType, openMenu, setCurrencyMenuType } = ModalsSlice.actions