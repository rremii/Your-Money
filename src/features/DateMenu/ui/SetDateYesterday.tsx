...
import { IsYesterday } from "@entities/DateSlider/model/IsYesterday.ts"
...
import YesterdayIcon from "@icons/general/moon.svg?react"
...
export const SetDateYesterday = () => {
  ...
  return (
    <PickDateBtn
      ...
      Icon={<YesterdayIcon className="icon" />}
      subTitle={subTitle}
    />
  )
}
